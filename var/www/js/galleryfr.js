$(function () {
    ...
    $().ready(function () {
		...
		if (source == "internal") {
			$("#textDeleteAllModal").text("Etes-vous sûrs de vouloir tout supprimer sur le stockage interne ?");
		} else {
			$("#textDeleteAllModal").text("Etes-vous sûrs de vouloir tout supprimer sur la carte SD ?");
		}
        ...
        $(document).on('click', '.xdelete', function () {
            //console.log("delete");
            if ($(".xdelete").attr('folder')  != "vide") {
                if ($(this).attr('element') == "folder") {
                    $("#textDeleteModal").text("Etes vous sûr de vouloir supprimer ce dossier ?");
                } else {
                    $("#textDeleteModal").text("Etes vous sûr de vouloir supprimer ce fichier ?");
                }
    ...
    function loadJPG(filename, num, page, source, element, firstFolder, broken) {
        ...
        else if (photoType == "gre") tooltip = "Vert";
        else if (photoType == "red") tooltip = "Rouge";
        else if (photoType == "reg") tooltip = "Red edge";
        else if (photoType == "nir") tooltip = "Proche infra-rouge";
    ...
    function loadPicture(filename, id) {
        ...
        else if (photoType == "GRE") photoType = "Vert";
        else if (photoType == "RED") photoType = "Rouge";
        else if (photoType == "REG") photoType = "Red edge";
        else if (photoType == "NIR") photoType = "Proche infra-rouge";
        $("#photoTitle").html("Photo - " + photoType);
